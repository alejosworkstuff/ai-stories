...
`.trim();
  ...
  try {
    ...
    story = Array.isArray(output) ? output.join("") : output;

  } catch (err) {
    // 👉 FALLBACK SI NO HAY CRÉDITOS / FALLA REPLICATE
    console.warn("⚠️ Replicate failed, using fallback story");
...
This fallback response keeps the application usable.
Once credits are added, stories will be generated by AI
